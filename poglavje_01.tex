...
\usepackage[stable]{footmisc} %opombe v naslovih
...
%\newcommand{\( formula \)}{\emph{formula} }
\newcounter{sourcepage}
\newcommand{\pagina}{\marginpar{\stepcounter{sourcepage}\thesourcepage}}
